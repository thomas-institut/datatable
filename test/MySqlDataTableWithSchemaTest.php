...
final class MySqlDataTableWithSchemaTest extends DataTableWithSchemaReferenceTestCase
{
    ...
    public function getTestTable(array $columnDefinitions): DataTableWithSchema
    {
        ...
        MySqlDbOperations::createTableInDatabase(MySqlDataTableWithSchema::class, $pdo, $tableName, $schema);
